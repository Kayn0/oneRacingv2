...
@IonicPage()
@Component({
  selector: 'page-driver-two',
  templateUrl: 'driver-two.html',
})
export class DriverTwoPage {
	public round: any;
  public lastRound = 0;
              ...
              if (carNum === 'two') {
                ...
                if (this.userDriverTwo.length < 1) {
                  ...
                  if (this.userDriverOne.length < 1){
                    ...
                    oldDriver = this.userDriverOne[0].abrev;
                  }
                  ...
                  if (oldDriver == newDriver) {
                    ...
                    if (newValue > this.teamCash) {
                      ...
                      this.teamData.addDriver(carData, this.userDriverTwo, carNum, this.userPoints, this.driverOneId);
                    }
                  }
                } else {
                  //make sure driver one and two are not the same
                  ...
                  if (oldDriver == newDriver) {  
                    ...
                    var oldValue = parseInt(this.userDriverTwo[0].driverValue);
                    newValue = carData.driverValue;
